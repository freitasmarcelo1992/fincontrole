...
<link rel="stylesheet" href="responsive.css?v=hub-menu-20260828-2248">
<style>
...
<aside class="sidebar" id="menu-completo">
    ...
    <a href="26.conciliacao.php"><i class="fa fa-building-columns"></i> Extrato</a>
...
<main class="main">
    ...
    <section class="app-home-hub" aria-label="Menu principal do FinControle">
        ...
        <div class="app-hub-grid">
            ...
            <a class="app-hub-card hub-extrato" href="26.conciliacao.php">
                <span class="app-hub-icon"><i class="fa-solid fa-building-columns"></i></span>
                <span>
                    <strong>Extrato</strong>
                    <small>Confer&ecirc;ncia banc&aacute;ria</small>
                </span>
            </a>
        </div>
    </section>
    ...
    <section class="quick-panels">
        <div class="panel">
            ...
            <div class="quick-box">
                ...
                <div class="quick-col gasto">
                    <h3><i class="fa-solid fa-cart-shopping"></i> Gasto rápido</h3>
                    <a class="quick-item" href="26.conciliacao.php">Mercado <i class="fa-solid fa-arrow-right"></i></a>
                    <a class="quick-item" href="26.conciliacao.php">Combustível <i class="fa-solid fa-arrow-right"></i></a>
                    <a class="quick-item" href="26.conciliacao.php">Farmácia <i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
