...
<title>FinControle | Início</title>
...
<style>
.app-home-hub{background:rgba(18,47,73,.92);border:1px solid rgba(40,180,235,.24);border-radius:16px;padding:18px;box-shadow:0 16px 36px rgba(0,0,0,.18);position:relative;z-index:5}
  ...
  .app-hub-grid{display:grid;grid-template-columns:minmax(0,1fr);gap:12px}
.app-hub-card{min-height:92px;display:flex;align-items:center;gap:14px;padding:16px;color:#fff;text-decoration:none;background:linear-gradient(135deg,rgba(15,43,68,.98),rgba(13,36,59,.98));border:1px solid rgba(92,197,244,.18);border-radius:14px;position:relative;z-index:6;pointer-events:auto;box-shadow:inset 0 1px 0 rgba(255,255,255,.04)}
  ...
  .app-hub-icon{width:42px;height:42px;flex:0 0 42px;display:inline-flex;align-items:center;justify-content:center;border-radius:15px;color:#fff;background:#149dd6;box-shadow:0 10px 20px rgba(0,0,0,.18)}
  .app-hub-icon i{font-size:1.05rem}
  .hub-treinos,.hub-relatorios{grid-column:1 / -1}
  .hub-financas .app-hub-icon{background:linear-gradient(135deg,#22c7f2,#087fb2)}.hub-noticias .app-hub-icon{background:linear-gradient(135deg,#22c7f2,#0e7490)}.hub-treinos .app-hub-icon{background:linear-gradient(135deg,#8b5cf6,#6d28d9)}.hub-relatorios .app-hub-icon{background:linear-gradient(135deg,#38bdf8,#0284c7)}.hub-extrato .app-hub-icon{background:linear-gradient(135deg,#fbbf24,#f59e0b)}
.app-home-hub ~ section,.legacy-dashboard-content{display:none!important}
body.dashboard-app .app-home-hub{flex:1;min-height:0;display:flex;flex-direction:column}
body.dashboard-app .app-hub-grid{flex:1;min-height:0;grid-template-columns:minmax(0,1fr);grid-template-rows:repeat(4,minmax(0,1fr))}
body.dashboard-app .app-hub-card{min-height:64px;min-width:0}
body.dashboard-app .app-hub-card > span:last-child{min-width:0;overflow-wrap:break-word}
  @media(max-width:768px){.app-dashboard-header .app-news-shortcut{display:none!important}.app-home-hub{min-height:calc(100svh - 224px);padding:14px;border-radius:14px;display:flex;flex-direction:column}.app-hub-heading{margin-bottom:12px}.app-hub-heading span{font-size:.72rem}.app-hub-heading strong{font-size:1rem}.app-hub-grid{gap:10px;flex:1;grid-template-rows:repeat(3,minmax(84px,1fr))}.app-hub-card{min-height:84px;gap:10px;padding:12px;border-radius:13px}.app-hub-icon{width:38px;height:38px;flex-basis:38px;border-radius:12px}.app-hub-card strong{font-size:.84rem}.app-hub-card small{font-size:.66rem}}
</style>
...
<main class="main">
    ...
    <section class="app-home-hub" aria-label="Menu principal do FinControle">
        <div class="app-hub-heading">
            ...
            <strong>Seu dinheiro, seus treinos e suas escolhas em equilíbrio</strong>
        </div>

        <div class="app-hub-grid">
            <a class="app-hub-card hub-financas" href="./28.financas.php" onclick="window.location.assign(this.href); return false;">
                <span class="app-hub-icon"><i class="fa-solid fa-wallet"></i></span>
                <span>
                    <strong>Finan&ccedil;as</strong>
                    <small>Saldo, receitas e despesas sob controle</small>
                </span>
            </a>
            <a class="app-hub-card hub-noticias" href="29.minhas_noticias.php">
                <span class="app-hub-icon"><i class="fa-solid fa-newspaper"></i></span>
                <span>
                    <strong>Minhas not&iacute;cias</strong>
                    <small>Finan&ccedil;as, carreira, sa&uacute;de e mais</small>
                </span>
            </a>
            <a class="app-hub-card hub-treinos" href="30.treinos.php">
                ...
                <span>
                    ...
                    <small>Treino padr&atilde;o e Full Body. Suas medidas e evolu&ccedil;&atilde;o.</small>
                </span>
            </a>
            <a class="app-hub-card hub-relatorios" href="07.relatorios.php">
                <span class="app-hub-icon"><i class="fa-solid fa-chart-simple"></i></span>
                <span>
                    <strong>Relat&oacute;rios</strong>
                    <small>Resultados e tend&ecirc;ncias das suas finan&ccedil;as</small>
                </span>
            </a>
    ...
    <div class="legacy-dashboard-content" hidden style="display:none!important">
